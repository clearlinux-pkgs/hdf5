...
Source0  : https://support.hdfgroup.org/ftp/HDF5/releases/hdf5-1.10/hdf5-1.10.11/src/hdf5-1.10.11.tar.gz
...
%prep
%setup -q -n hdf5-1.10.11
cd %{_builddir}/hdf5-1.10.11
%patch -P 1 -p1
pushd ..
cp -a hdf5-1.10.11 build-openmpi
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720039293
...
cp %{_builddir}/hdf5-%{version}/COPYING_LBNL_HDF5 %{buildroot}/usr/share/package-licenses/hdf5/c0af5665ca5eb578356f2f6a93c45b46cdddf8a0 || :
cp %{_builddir}/hdf5-%{version}/config/sanitizer/LICENSE %{buildroot}/usr/share/package-licenses/hdf5/7e4756da18354f570a8c9e42222d7b722a3b4275 || :
export GOAMD64=v2
GOAMD64=v3
pushd ../build-openmpi/
module load openmpi
...
/usr/share/hdf5_examples/c/ph5_filtered_writes.c
/usr/share/hdf5_examples/c/ph5_filtered_writes_no_sel.c
...
/usr/lib64/libhdf5.so.103.4.1
/usr/lib64/libhdf5_cpp.so.103
/usr/lib64/libhdf5_cpp.so.103.4.3
/usr/lib64/libhdf5_fortran.so.102
/usr/lib64/libhdf5_fortran.so.102.1.4
/usr/lib64/libhdf5_hl.so.100
/usr/lib64/libhdf5_hl.so.100.1.8
/usr/lib64/libhdf5_hl_cpp.so.100
/usr/lib64/libhdf5_hl_cpp.so.100.1.9
/usr/lib64/libhdf5hl_fortran.so.100
/usr/lib64/libhdf5hl_fortran.so.100.0.10

%files license
%defattr(0644,root,root,0755)
/usr/share/package-licenses/hdf5/7e4756da18354f570a8c9e42222d7b722a3b4275
/usr/share/package-licenses/hdf5/c0af5665ca5eb578356f2f6a93c45b46cdddf8a0
...
/usr/lib64/openmpi/lib/libhdf5.so.103.4.1
/usr/lib64/openmpi/lib/libhdf5_fortran.so.102
/usr/lib64/openmpi/lib/libhdf5_fortran.so.102.1.4
/usr/lib64/openmpi/lib/libhdf5_hl.so.100
/usr/lib64/openmpi/lib/libhdf5_hl.so.100.1.8
/usr/lib64/openmpi/lib/libhdf5hl_fortran.so.100
/usr/lib64/openmpi/lib/libhdf5hl_fortran.so.100.0.10
...
/usr/lib64/openmpi/share/hdf5_examples/c/ph5_filtered_writes.c
/usr/lib64/openmpi/share/hdf5_examples/c/ph5_filtered_writes_no_sel.c
